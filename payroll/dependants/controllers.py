...
# GET /dependants
@dependant_router.get("", response_model=DependentPersonsRead)
...
@dependant_router.get("/{dependant_id}", response_model=DependentPersonRead)
...
# POST /dependants
@dependant_router.post("", response_model=DependentPersonRead)
def create(*, dependant_in: DependentPersonCreate, db_session: DbSession):
...
@dependant_router.put("/{dependant_id}", response_model=DependentPersonRead)
def update(
    *,
    db_session: DbSession,
    dependant_id: int,
    dependant_in: DependentPersonUpdate,
):
...
@dependant_router.delete("/{dependant_id}", response_model=DependentPersonRead)
