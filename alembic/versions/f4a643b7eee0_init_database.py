...
Revision ID: f4a643b7eee0
Revises:
Create Date: 2024-08-17 16:45:20.293687
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "replay",
            sa.Enum("DAILY", "MONTHLY", "YEARLY", name="benefitreplay"),
            nullable=False,
        ),
        sa.Column("count_salary", sa.Boolean(), nullable=False),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", "contract_id", "benefit_id"),
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("contract_benefit_association")
