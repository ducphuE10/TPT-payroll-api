...
Revision ID: 7862e88fec25
Revises:
Create Date: 2024-09-24 21:37:25.971119
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("earliest_checkin", sa.Time(), nullable=True),
        sa.Column("latest_checkin", sa.Time(), nullable=True),
        sa.Column("checkout", sa.Time(), nullable=True),
        sa.Column("earliest_checkout", sa.Time(), nullable=True),
        sa.Column("latest_checkout", sa.Time(), nullable=True),
        sa.Column("created_by", sa.String(length=30), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("new_basic_salary", sa.Float(), nullable=True),
        sa.Column("new_meal_benefit", sa.Float(), nullable=True),
        sa.Column("new_transportation_benefit", sa.Float(), nullable=True),
        sa.Column("new_housing_benefit", sa.Float(), nullable=True),
        sa.Column("new_toxic_benefit", sa.Float(), nullable=True),
        sa.Column("new_phone_benefit", sa.Float(), nullable=True),
        sa.Column("new_attendant_benefit", sa.Float(), nullable=True),
        sa.Column("template", sa.String(length=255), nullable=True),
        sa.Column("created_by", sa.String(length=30), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
